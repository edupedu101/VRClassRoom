# Generated by Django 3.2 on 2022-04-06 14:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tarea', models.ForeignKey(default=False, on_delete=django.db.models.deletion.DO_NOTHING, to='vroom.tarea')),
                ('usuario', models.ForeignKey(default=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto_puntuacion', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='vroom.auto_puntuacion')),
                ('autor', models.ForeignKey(default=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
                ('tarea', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='vroom.tarea')),
            ],
        ),
        migrations.CreateModel(
            name='Documento',
